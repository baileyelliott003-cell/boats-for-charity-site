...
for (const file of htmlFiles) {
  ...
  // Ensure Google Ads AW-18239894267 config is present on existing Google tag
...
console.log(`[batch-inject] Verified Google Ads destination AW-18239894267 across ${htmlFiles.length} HTML files (${updated} updated).`);
