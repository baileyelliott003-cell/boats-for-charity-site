...
const replacements = {
  "city/lake-ozark/index.html": [
    ...
    ["Yes. Describe what is wrong, how long the boat has sat, where it is kept, and how the hull, engine, and trailer look now. Boats that skip a haul-out or sit a winter often wake up rough, so an honest account helps. Every boat is reviewed on its own.", "You may submit it for individual review. State the last launch and winterization dates, what has actually been tested, whether it remains afloat or on a lift, and what current photos show about the hull, engine, bilge, and trailer. Do not turn an unverified guess such as &quot;just needs a battery&quot; into a condition claim."],
    ["List what you have and what is missing. The next step depends on the Missouri title and registration, any lien, the legal owner, and whether the trailer is titled separately. We will explain what usually resolves each gap.", "List the name on each available boat and trailer record, the identification numbers, any lien or estate issue, and exactly what is missing. The issuing agency determines how an ownership gap may be resolved; the donation review cannot replace that process."],
    ["Yes. Keep the boat stored, insured, and secured until a transfer is complete and the marina or storage facility confirms its own requirements. Do not cancel anything based on an early inquiry.", "Yes. Keep the slip, lift, dry-storage, insurance, winterization, and security arrangements current until ownership has transferred and the facility confirms its release requirements. A form submission or follow-up call is not a handoff."],
  ],
  "city/jacksonville/index.html": [
    ...
    ["Yes. Between salt, humidity, and a couple of idle seasons, a boat that won't start is common here. Tell us what failed, how long she's been sitting, whether she's in a river slip or on a trailer, and the state of the hull and engine. Every boat is reviewed on its own facts.", "You may submit it for individual review. State what was actually tested, the last verified operating date, salt or brackish-water use, known storm exposure, storage setting, and current hull, engine, bilge, and trailer condition. Mark unknowns as unknown instead of guessing at a repair."],
    ["List what you have and what's missing. Florida titles and registers boats through the Department of Highway Safety and Motor Vehicles, larger boats may be Coast Guard documented, and the trailer has its own title, so the step depends on how yours is recorded, any lien, and the legal owner.", "List every available hull, trailer, lien, estate, and federal-documentation record and the name and number on each. Then confirm the current ownership path with the agency that holds the vessel or trailer record; the review does not cure a missing signature or unresolved lien."],
    ["No. Keep the boat secured and your slip, storage, and coverage in place until the transfer is complete and the marina, insurer, and any agency have received whatever notice they require.", "No. Keep the boat secured and keep the slip, rack, trailer storage, and insurance current until ownership has transferred and each facility, insurer, and issuing agency has received the required notice."],
  ],
  "city/manchester/index.html": [
    ...
    ["You may submit it for individual review. Trailer boats that skip a summer or two often will not start again, and that alone rules nothing out. Describe the issue, how long it has been idle, how it was winterized, and the hull and engine condition. Every boat is reviewed on its own.", "You may submit it for individual review. Distinguish a confirmed failure from a boat that simply has not been tested. Give the last verified run and winterization, current battery and fuel status if known, storage setting, and photographs of the hull, bilge, engine or outdrive, and trailer."],
    ["Note what you have and what you do not. The next step depends on the issuing state, any lien, the legal owner, and whether the trailer has its own separate title. We will help you find the correct path rather than guess.", "Inventory the records separately: vessel, trailer, lien, and any estate or trust document. List the issuing agency, owner name, and identification number on each, then mark exactly what is missing. The issuing agency—not the donation review—determines whether and how a record can be replaced or corrected."],
    ["No. Keep the boat secure and keep any storage and insurance current until the transfer is complete and the facility, insurer, and any agency have the notice they need. An inquiry does not end those obligations.", "No. A review request does not change custody or end storage, insurance, winterization, or security obligations. Keep them current until ownership has transferred and each facility, insurer, lender, and issuing agency has received any required notice."],
  ],
  "city/santa-barbara/index.html": [
    ...
    ["You may submit it for individual review. A boat that has sat quietly on its slip or mooring for a season or two is a common story here. Tell us how long it has been idle, when the engine last ran, and the condition of the hull, running gear, and bottom. Every boat is reviewed on its own facts.", "You may submit it for individual review. State whether the engine has failed or simply has not been tested, the last verified operating and haul-out dates, current bilge and hull condition, bottom and running-gear observations, and how a future buyer could lawfully reach the vessel after a sale."],
    ["List what you have and what is missing. Larger Channel boats are often federally documented rather than state titled, smaller boats carry California DMV registration, and the trailer is separate. The next step depends on the legal owner, any lien, and how the boat was recorded.", "List each available record and its issuing agency, owner name, and identification number. Separate California vessel records, federal documentation, liens, trailer paperwork, and authority documents. The agency holding a record determines how a missing or incorrect item may be resolved."],
    ["Yes. Keep the boat in its slip or on its mooring, insured, and secured until the transfer is actually complete. A first inquiry does not change ownership, and giving up a hard-to-get harbor slip or dropping coverage early can leave you exposed if timing shifts.", "Yes. A request does not change custody. Keep moorage or storage, insurance, security, and required maintenance in place until ownership has transferred and the harbor, marina, yard, insurer, lender, and issuing agencies have received any required notice."],
  ],
  "city/wilmington-de/index.html": [
    ...
    ["You may submit it for individual review. Tell us what failed, how long it has sat, whether it was winterized, and the current condition of the hull and engine. Boats on the tidal Delaware pick up growth and corrosion when idle, so note that too. We review every boat individually.", "You may submit it for individual review. State what was actually tested, the last verified run and winterization, whether the boat remains afloat or hauled, and what current photos show about the hull, bilge, engine, and running gear. Engine status alone does not decide acceptance."],
    ["List what you have and what is missing. The next step depends on whether the boat is Delaware titled or Coast Guard documented, the lien status, the legal owner, and whether the trailer carries its own title. The agency holding each record determines what applies and whether a correction is available.", "List the issuing agency, printed owner, and identification number on each available vessel and trailer record, along with any lien or authority document. The agency holding a record determines whether and how an omission can be corrected; the donation review does not replace that process."],
    ["Is transport off my dock guaranteed?", "Does a Wilmington river berth include pickup?"],
    ["No. Keep the boat insured, blocked, and secured until the transfer is complete and the marina or yard has confirmed any notice it needs. A boat left unprotected over a mid-Atlantic winter can suffer freeze damage.", "No. Keep the berth or yard space, insurance, winter protection, and security current until ownership has transferred and the facility confirms its release requirements. A form submission is not a handoff."],
