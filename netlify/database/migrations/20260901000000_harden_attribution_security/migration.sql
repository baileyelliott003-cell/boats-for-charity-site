...
CREATE UNIQUE INDEX IF NOT EXISTS admin_sessions_token_hash_uniq ON admin_sessions(token_hash);
...
CREATE UNIQUE INDEX IF NOT EXISTS abuse_rate_limits_scope_identifier_uniq ON abuse_rate_limits(scope, identifier_hash);
CREATE INDEX IF NOT EXISTS abuse_rate_limits_updated_at_idx ON abuse_rate_limits(updated_at);
